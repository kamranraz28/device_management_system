...
<div class="col-md-9 col-lg-8 col-xl-12">
    <br>
    <br>
    <h1 style="text-align:center">Send QR Code</h1>
    <br>
...
<div class="row">
    ...
    <h4 style="text-align:center">Device SN: {{$sn}}</h4>
        <form action="{{ route('qr', ['sn' => $sn]) }}"
        method="POST" style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
            @csrf

            <div class="form-group" style="margin-bottom: 15px;">
                
                <input type="text" id="message" name="message" class="form-control" placeholder="Enter URL" required style="width: calc(100% - 20px); padding: 10px; box-sizing: border-box; border-radius: 4px; border: 1px solid #ccc;">
            </div>
